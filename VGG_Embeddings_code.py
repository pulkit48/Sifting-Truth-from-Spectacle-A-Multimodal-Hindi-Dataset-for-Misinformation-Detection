...
csv_path = r"C:\Users\2raun\Desktop\New Dataset Final\Final\VGG19.csv"
...
csv_file_path = r"C:\Users\2raun\Desktop\New Dataset Final\Final\VGG19.csv"
...
print("\nApplying PCA to VGG Embeddings...")
resnet_reduced = pca_resnet.fit_transform(resnet_features)
print("VGG Embeddings after PCA shape:", resnet_reduced.shape)
print(resnet_reduced)

reduced_df = pd.DataFrame(resnet_reduced)
reduced_df.insert(0, 'ImageName', image_names)

reduced_csv_file_path = r"C:\Users\2raun\Desktop\New Dataset Final\Final\pca_vgg_emb.csv"
reduced_df.to_csv(reduced_csv_file_path, index=False)

print(f"Reduced VGG embeddings saved to {reduced_csv_file_path}")
